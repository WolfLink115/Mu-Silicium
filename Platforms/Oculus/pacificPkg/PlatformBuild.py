...
class CommonPlatform ():
    PackagesSupported = ("pacificPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('pacific', 'gcc_aarch64_linux', 'edk2-build')
    ...
    PackagesPath = (
        ...
        "Silicon/Qualcomm",
        "Silicon/Silicium",
        "Silicium-ACPI/Platforms/Oculus",
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "pacific", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "pacificPkg/pacific.dsc", "Platform Hardcoded")
