...
gDeviceMemoryDescriptorEx[] = {
  ...
  {"RAM Partition",     0x80024000, 0x000DC000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv, WRITE_BACK_XN},
  ...
  {"HLOS 5",            0xA0000000, 0x00000000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv, WRITE_BACK},
